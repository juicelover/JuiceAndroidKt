...
object GlideUtils {
    ...
    /*** 占位图  */
    var placeholderImage: Int = R.drawable.default_empty_detail

    /*** 错误图  */
    var errorImage: Int = R.drawable.default_empty_detail
    ...
    fun loadImage(
        ...
        url: String?,
        imageView: ImageView,
        errorImage: Int = R.drawable.default_empty_detail
    ) {
    ...
    fun loadCircleWithBorderImage(
        ...
        borderSize: Float, @ColorInt borderColor: Int
    ) {
    ...
    fun loadRoundCircleImage(
        context: Context, url: String?, imageView: ImageView,
        radius: Float, type: RoundedCornersTransformation.CornerType?
    ) {
        val options = RequestOptions.bitmapTransform(
            MultiTransformation(
                CenterCrop(),
                RoundedCornersTransformation(radius.px2dp(), 0, type)
            )
        )
            .placeholder(placeholderImage) //占位图
            .error(errorImage) //错误图
